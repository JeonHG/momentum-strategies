...
spy_df = pd.read_csv('/content/drive/MyDrive/quant_projects/momentum_strategies/SPY.csv')[:-2] # 2021-09까지 결과 출력
...
spy_dividend_df = pd.read_csv('/content/drive/MyDrive/quant_projects/momentum_strategies/SPY_dividends.csv')
...
chart.figure.savefig(f'/content/drive/MyDrive/quant_projects/momentum_strategies/{current_date}_returns_highlights.jpg')
